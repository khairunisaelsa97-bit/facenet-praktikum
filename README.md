...
1. build_embeddings.py — Analisis
...
2. convert_npz_to_npy.py — Analisis
...
7. train_classifier.py — Analisis
...
11. Webcam Realtime (Jika Ada) — Analisis
Jika kamu menambahkan script realtime webcam:
Kamera dibuka dengan OpenCV
MTCNN mendeteksi wajah setiap frame
Embedding dibuat secara realtime
KNN memprediksi identitas
